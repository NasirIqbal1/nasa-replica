      ...
      <div className="relative z-10 flex items-center justify-center h-full px-12">
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center justify-center transform lg:translate-y-[350px] md:translate-y-[300px] translate-y-[200px]">
          <div className="flex flex-col items-center text-start lg:items-start lg:text-left">
            <h2 className="text-[48px] lg:text-[85px] md:text-[80px] font-bold leading-[1] mb-[60px] text-white">
            ...
            <a
              href="/"
              target="_self"
              className="flex items-center gap-2 text-[22px] text-white font-bold py-3 self-start"
            >
              Mars Exploration
              <svg
                viewBox="0 0 32 32"
